...
namespace BitSits_Framework
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        /// <summary>
        /// A default GameContent shared by all the screens. This saves
        /// each screen having to bother creating their own local instance.
        /// </summary>
        public GameContent GameContent { get { return gameContent; } }

        /// <summary>
        /// A default GraphicsDeviceManager shared by all the screens. This saves
        /// each screen having to bother creating their own local instance.
        /// </summary>
        ...
        protected override void UnloadContent()
        {
            ...
            if (gameContent != null) gameContent.UnloadContent();
        }
        ...
        {
            if (gameContent == null) gameContent = new GameContent(this);
        }
